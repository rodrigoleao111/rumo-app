package com.rodrigoleao.pipa.data.import_trip
...
import com.rodrigoleao.pipa.data.db.entity.WalkStopEntity
import com.rodrigoleao.pipa.data.model.BadgeType
import com.rodrigoleao.pipa.data.model.ChecklistItem
import com.rodrigoleao.pipa.data.model.DuplicateTripException
import com.rodrigoleao.pipa.data.model.Note
import com.rodrigoleao.pipa.data.model.NoteBlock
import com.rodrigoleao.pipa.data.model.NoteBlockType
...
class TravelImporter @Inject constructor(
    ...
    private suspend fun writeToDb(parsed: ParsedZip): Long {
        ...
        val tripId = tripRepo.createTrip(
            ...
            coverImage   = exported.coverImage,
        ...
        for (expContact in exported.contacts) {
            val isBuiltinType = com.rodrigoleao.pipa.data.model.ContactType.entries
                .any { it.name == expContact.type && it != com.rodrigoleao.pipa.data.model.ContactType.CUSTOM }
            ...
            contactRepo.upsertContact(
                ...
                entity = ContactEntity(
                    ...
                    contactType    = if (isBuiltinType) expContact.type else com.rodrigoleao.pipa.data.model.ContactType.CUSTOM.name,
    ...
    private fun parseTripJson(json: String): ExportedTrip {
        ...
        return ExportedTrip(
            ...
            coverImage    = trip.optString("coverImage", ""),
